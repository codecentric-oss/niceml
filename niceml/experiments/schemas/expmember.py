...
class FolderMember(ExpMember):
    ...
    def get_docstring(self) -> str:
        """
        The get_docstring function is used to generate the docstring for a given
        :class:`~.FileChecker`. The function takes no arguments and returns a string
        containing the ReST formatted docstring. This function should be overridden by
        subclasses of :class:`~.FileChecker` that require additional information in their
        docstrings.
